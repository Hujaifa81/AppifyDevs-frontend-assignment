...
const RevenueChart = dynamic(() => import('@/components/modules/Dashboard/RevenueChart'), {
    ssr: false,
    loading: () => <Skeleton className="h-[400px] rounded-3xl border border-border/50 shadow-sm" />
});
...
const ManagerRevenue = () => {
    ...
    const handleExport = useCallback(() => {
        ...
        exportToCSV(exportData, 'manager_revenue_report');
                                ...
                                <div className="overflow-x-auto">
                                    <table className="w-full">
                                        ...
                                        <tbody className="divide-y divide-border/50">
                                            {revenue.data.map((d) => (
                                                <tr key={`manager-rev-${d.label}`} className="group hover:bg-muted/20 transition-colors">
